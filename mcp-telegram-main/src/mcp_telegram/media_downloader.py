...
try:
    from telethon.tl.types import MessageMediaVideo, MessageMediaPhoto, MessageMediaDocument
    from telethon.tl.types import DocumentAttributeVideo, DocumentAttributeFilename
except ImportError:
    # Fallback для разных версий telethon
    from telethon.tl.types import (
        MessageMediaVideo, MessageMediaPhoto, MessageMediaDocument,
...
# Удобные функции
async def download_video_from_message(dialog_id: int, message_id: int, path: Optional[str] = None):
