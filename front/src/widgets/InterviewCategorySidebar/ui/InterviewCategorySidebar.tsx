...
export const InterviewCategorySidebar: React.FC<InterviewCategorySidebarProps> = ({
  ...
  const hasQuestionsField = (data: unknown): data is QuestionsResponseData => {
    return typeof data === 'object' && data !== null && Array.isArray((data as QuestionsResponseData).questions);
  };
