...
def preview_cleaning(original: str, cleaned: str, max_preview_length: int = 200) -> None:
    """Show a preview of what will be cleaned."""
    try:
        print("Original (first {} chars):".format(max_preview_length))
        print(repr(original[:max_preview_length]))
        print("\nCleaned (first {} chars):".format(max_preview_length))
            ...
            if content_changed or full_content_changed:
                ...
                if dry_run:
                    ...
                    if full_content_changed:
                        ...
                        preview_cleaning(original_full_content, cleaned_full_content, 150)
                else:
                    # Update the record
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Clean interview content from metadata")
    parser.add_argument(
        "--dry-run", 
        action="store_true", 
