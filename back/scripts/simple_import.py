...
def main():
    ...
    try:
        ...
        # Загрузка данных
        with open(data_path / "questions_full_final.json", encoding="utf-8") as f:
            questions = json.load(f)
        with open(data_path / "categories_final.json", encoding="utf-8") as f:
        ...
        for cat in categories:
            category_id = (
                cat["name"].lower().replace(" ", "_").replace("ь", "").replace("ё", "e")
            )
