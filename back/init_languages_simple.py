...
def init_supported_languages():
    ...
    try:
        ...
        languages_data = [
            ("python", "Python", "PYTHON", "3.11", "python:3.11-slim", ".py", None, "python /tmp/code.py", 30, 128, True),
            ("javascript", "JavaScript (Node.js)", "JAVASCRIPT", "18", "node:18-slim", ".js", None, "node /tmp/code.js", 30, 128, True),
            ("java", "Java", "JAVA", "17", "openjdk:17-slim", ".java", "javac /tmp/Main.java", "java -cp /tmp Main", 45, 256, True),
            ("cpp", "C++", "CPP", "17", "gcc:latest", ".cpp", "g++ -o /tmp/code /tmp/code.cpp", "/tmp/code", 30, 128, True),
            ("c", "C", "C", "11", "gcc:latest", ".c", "gcc -o /tmp/code /tmp/code.c", "/tmp/code", 30, 128, True),
            ("go", "Go", "GO", "1.21", "golang:1.21-alpine", ".go", None, "go run /tmp/code.go", 30, 128, True),
            ("rust", "Rust", "RUST", "1.70", "rust:1.70-slim", ".rs", "rustc /tmp/code.rs -o /tmp/code", "/tmp/code", 45, 256, True)
        ]
