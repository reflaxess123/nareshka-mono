...
from ...shared.dependencies import get_current_user_optional, get_current_user_required, get_content_service
...
async def get_content_categories(content_service: ContentService = Depends(get_content_service)):
