...
from ...application.dto.mindmap_dto import (
    MindMapGenerateRequest, MindMapResponse, MindMapDataResponse,
    TechnologiesResponse, TechnologiesDataResponse, TopicTasksRequest,
    TopicTasksResponse, TaskDetailResponseWrapper, HealthResponse,
    MindMapNodeResponse, MindMapEdgeResponse, TopicResponse, TaskResponse,
    TaskProgressResponse, TopicStatsResponse, TaskDetailResponse,
...
async def get_available_technologies(
    ...
    try:
        ...
        data = TechnologiesDataResponse(
            technologies=technologies_data["technologies"],
            configs=configs
        )
