...
class RegisterRequest(BaseCreateRequest):
    ...
    username: Optional[str] = Field(
        None, min_length=3, max_length=20, description="Username (optional)"
    )
...
class UpdateUserProfileRequest(BaseUpdateRequest):
    ...
    username: Optional[str] = Field(
        None, min_length=3, max_length=20, description="Username"
    )
    first_name: Optional[str] = Field(None, max_length=100, description="First name")
    last_name: Optional[str] = Field(None, max_length=100, description="Last name")
...
class LogoutRequest(BaseModel):
    ...
    class Config:
        schema_extra = {"example": {"logout_all_devices": False}}
