...
from app.features.interviews.repositories.categories_repository import (
...
class CategoriesService:
    ...
    def get_category_detail(
        self, category_id: str, limit_questions: int = 10
    ) -> CategoryDetailResponse:
        ...
        return CategoryDetailResponse(
            category=category, clusters=clusters, sample_questions=sample_questions
        )

    def get_cluster_questions(
        self, cluster_id: int, page: int = 1, limit: int = 50
    ...
    def get_top_companies(self, limit: int = 20) -> List[CompanyResponse]:
        ...
        return [
            CompanyResponse(name=company["name"], count=company["count"])
    ...
    def get_all_clusters(
        ...
        clusters_data = self.repository.get_all_clusters(
            category_id=category_id, search=search, limit=limit
        )
