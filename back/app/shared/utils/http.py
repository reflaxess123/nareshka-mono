...
class ApiResponse(BaseModel):
    ...
    @classmethod
    def success_response(cls, data: Any = None, message: str = "Success", meta: Optional[Dict[str, Any]] = None) -> 'ApiResponse':
    ...
    @classmethod
    def error_response(cls, message: str = "Error", errors: Optional[List[str]] = None, 
...
def extract_pagination(request: Request, default_size: int = 20, max_size: int = 100) -> PaginationParams:
    ...
    try:
        ...
        logger.warning("Invalid pagination parameters", extra={
...
def extract_filters(request: Request, allowed_filters: List[str]) -> Dict[str, Any]:
    ...
    logger.debug("Extracted filters", extra={
        "filters": filters,
...
def extract_sort_params(request: Request, allowed_fields: List[str], default_field: str = "id") -> Dict[str, str]:
...
def log_request(request: Request, user_id: Optional[str] = None, extra_data: Optional[Dict[str, Any]] = None):
...
def create_paginated_response(
    ...
    response_data = ApiResponse.success_response(data=paginated_data.dict(), message=message)
...
class RequestContext:
    ...
    def log_context(self, level: str = "info", message: str = "Request context", **extra):
        """Log request context."""
