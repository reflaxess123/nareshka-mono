...
class TaskInfo:
    ...
    def __init__(self, task_id: str, title: str, description: str, task_type: str, **kwargs):
...
class ContentAdapter:
    ...
    def get_content_info(self, content_id: str) -> Optional[ContentInfo]:
        ...
        try:
            ...
            logger.error(f"Error getting content info: {e}", extra={'content_id': content_id})
            return None
    ...
    def get_contents_info(self, content_ids: List[str]) -> List[ContentInfo]:
        ...
        try:
            ...
            return [ContentInfo.from_dict(content_data) for content_data in contents_data]
        except Exception as e:
            logger.error(f"Error getting contents info: {e}", extra={'content_ids': content_ids})
            return []
