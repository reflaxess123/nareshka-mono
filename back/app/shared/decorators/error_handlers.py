    ...
    def decorator(func: Callable) -> Callable:
        ...
        async def wrapper(*args, **kwargs):
            try:
                ...
                logger.warning(
                    f"API exception in {operation_name}: {e.message}",
                    extra={
                ...
                logger.warning(
                    f"Resource not found in {operation_name}: {str(e)}",
                    extra={"operation": operation_name, "function": func.__name__},
                )
                raise HTTPException(
                ...
                logger.warning(
                    f"Resource conflict in {operation_name}: {str(e)}",
                    extra={"operation": operation_name, "function": func.__name__},
                )
                ...
                logger.warning(
                    f"Authentication error in {operation_name}: {str(e)}",
                    extra={"operation": operation_name, "function": func.__name__},
                )
                raise HTTPException(
                ...
                logger.warning(
                    f"Authorization error in {operation_name}: {str(e)}",
                    extra={"operation": operation_name, "function": func.__name__},
                )
                raise HTTPException(
                ...
                if error_mapping:
                    for exc_type, (status_code, message) in error_mapping.items():
                        if isinstance(e, exc_type):
                            logger.warning(
                                f"Mapped exception in {operation_name}: {str(e)}",
                                extra={
                                    "operation": operation_name,
                                    "function": func.__name__,
                                    "error_type": type(e).__name__,
