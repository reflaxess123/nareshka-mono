...
def validation_error(message: str, field: str = None, value: Any = None) -> ValidationException:
    """Создать ошибку валидации"""
    return ValidationException(message, field, value)


def not_found(resource_type: str, resource_id: Union[str, int] = None) -> ResourceNotFoundException:
...
def forbidden(message: str = "Access denied", required_role: str = None) -> AuthorizationException:
    """Создать ошибку авторизации"""
    return AuthorizationException(message, required_role)


def conflict(resource_type: str, field: str = None, value: Any = None) -> ResourceConflictException:
...
def external_service_error(service: str, message: str = "Service unavailable") -> ExternalServiceException:
    """Создать ошибку внешнего сервиса"""
    return ExternalServiceException(service, message)


def database_error(message: str = "Database error", operation: str = None, table: str = None) -> DatabaseException:
