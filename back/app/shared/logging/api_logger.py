...
class APILogger:
    ...
    def log_operation_start(self, operation: str, **kwargs) -> None:
        ...
        self.logger.info(f"API: Starting {operation}", extra={
            "operation": operation,
            "module": self.module,
            "stage": "start",
            **kwargs
    ...
    def log_operation_success(self, operation: str, **kwargs) -> None:
        ...
        self.logger.info(f"API: Successfully completed {operation}", extra={
            "operation": operation,
            "module": self.module,
            "stage": "success",
            **kwargs
    ...
    def log_operation_error(self, operation: str, error: Exception, **kwargs) -> None:
        ...
        self.logger.error(f"API: Error in {operation}: {str(error)}", extra={
            "operation": operation,
            "module": self.module,
            "stage": "error",
    ...
    def log_operation_warning(self, operation: str, message: str, **kwargs) -> None:
        ...
        self.logger.warning(f"API: Warning in {operation}: {message}", extra={
            "operation": operation,
            "module": self.module,
            "stage": "warning",
    ...
    def log_request_details(self, request: Request, operation: str, **kwargs) -> None:
        ...
        self.logger.debug(f"Request details for {operation}", extra={
            "operation": operation,
            "module": self.module,
    ...
    def log_data_access(self, operation: str, data_type: str, count: Optional[int] = None, **kwargs) -> None:
    ...
    def log_performance(self, operation: str, duration_ms: float, **kwargs) -> None:
        ...
        self.logger.info(f"Performance: {operation} took {duration_ms:.2f}ms", extra={
            "operation": operation,
            "module": self.module,
