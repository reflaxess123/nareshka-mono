...
class BaseModel:
    ...
    def update_from_dict(self, data: Dict[str, Any], exclude: Optional[set] = None) -> None:
        ...
        logger.debug(f"Updated {self.__class__.__name__} with data", extra={
...
class SoftDeleteMixin:
    ...
    def soft_delete(self, user_id: Optional[str] = None) -> None:
        ...
        logger.info(f"Soft deleted {self.__class__.__name__}", extra={
            "model": self.__class__.__name__,
    ...
    def restore(self, user_id: Optional[str] = None) -> None:
        ...
        logger.info(f"Restored {self.__class__.__name__}", extra={
            "model": self.__class__.__name__,
            "model_id": getattr(self, 'id', None),
            "restored_by": user_id
        })
