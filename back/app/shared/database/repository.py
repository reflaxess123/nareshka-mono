...
class BaseRepository(Generic[T]):
    ...
    def create(self, data: Dict[str, Any], session: Session = None) -> T:
        ...
        try:
            ...
            logger.error(
                ...
                extra={"model": self.model_name, "error": str(e), "data": data},
            )
            raise DuplicateEntityError(f"Duplicate {self.model_name}")

        except Exception as e:
            logger.error(
                f"Error creating {self.model_name}",
                extra={"model": self.model_name, "error": str(e), "data": data},
            )
    ...
    def get_by_id(self, entity_id: Any, session: Session = None) -> Optional[T]:
        ...
        try:
            entity = (
                session.query(self.model).filter(self.model.id == entity_id).first()
            )

            if entity:
                logger.debug(
                    f"Found {self.model_name} by ID",
                    extra={"model": self.model_name, "entity_id": entity_id},
                )
            ...
            logger.error(
                f"Error getting {self.model_name} by ID",
                extra={
                    "model": self.model_name,
                    "entity_id": entity_id,
                    "error": str(e),
    ...
    def get_by_id_or_raise(self, entity_id: Any, session: Session = None) -> T:
        ...
        if not entity:
            raise EntityNotFoundError(
                f"{self.model_name} with id {entity_id} not found"
            )
        return entity
    ...
    def get_all(
        ...
        try:
            ...
            logger.debug(
                f"Retrieved {len(entities)} {self.model_name} entities",
                extra={
                    "model": self.model_name,
                    "count": len(entities),
                    "filters": filters,
            ...
            logger.error(
                f"Error getting {self.model_name} entities",
    ...
    @transactional
    def update(
        self, entity_id: Any, data: Dict[str, Any], session: Session = None
    ) -> T:
        """Update entity by ID."""
        try:
            ...
            raise DuplicateEntityError(
                f"Update violates constraints for {self.model_name}"
            )
        except Exception as e:
            logger.error(
                f"Error updating {self.model_name}",
                extra={
                    "model": self.model_name,
                    "entity_id": entity_id,
                    "error": str(e),
    ...
    def delete(self, entity_id: Any, session: Session = None) -> bool:
        ...
        try:
            ...
            logger.error(
                f"Error deleting {self.model_name}",
                extra={
                    "model": self.model_name,
                    "entity_id": entity_id,
                    "error": str(e),
    ...
    def count(
        ...
        try:
            ...
            logger.debug(
                f"Counted {count} {self.model_name} entities",
                extra={"model": self.model_name, "count": count, "filters": filters},
            )
            ...
            logger.error(
                f"Error counting {self.model_name} entities",
    ...
    def bulk_create(
        ...
        try:
            ...
            logger.info(
                f"Bulk created {len(entities)} {self.model_name} entities",
                extra={"model": self.model_name, "count": len(entities)},
            )
            ...
            logger.error(
                f"Error bulk creating {self.model_name} entities",
                extra={
                    "model": self.model_name,
                    "error": str(e),
                    "count": len(data_list),
...
class ReadOnlyRepository(BaseRepository[T]):
    ...
    def create(self, *args, **kwargs):
        raise NotImplementedError(
            "Create operation not allowed in read-only repository"
        )

    def update(self, *args, **kwargs):
        raise NotImplementedError(
            "Update operation not allowed in read-only repository"
        )

    def delete(self, *args, **kwargs):
        raise NotImplementedError(
            "Delete operation not allowed in read-only repository"
        )

    def bulk_create(self, *args, **kwargs):
        raise NotImplementedError(
            "Bulk create operation not allowed in read-only repository"
        )
